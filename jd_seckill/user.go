...
func (this *User) QrLogin() (string, error) {
	...
	resp, err := req.SetUrl("https://qr.m.jd.com/show?appid=133&size=300&t="+strconv.Itoa(int(time.Now().Unix()*1000))).SetMethod("get").Send().EndFile("jd_seckill/", "qr_code.png")
	...
	dir, _ := os.Getwd()
	common.OpenImage(dir + "/jd_seckill/qr_code.png")
